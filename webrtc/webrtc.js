...
// Ensure there is no trailing slash here if there isn't one in Java
const socket = new SockJS('http://englacial-lynell-prohibitively.ngrok-free.dev/signal', null, {transports: ['websockect']});
...
function createPeerConnection() {
  ...
  const isCaller = location.hash === "#caller"; // example
