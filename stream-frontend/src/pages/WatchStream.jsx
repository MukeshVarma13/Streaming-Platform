  ...
  return (
    <div className="fixed left-0 right-0 top-0 bottom-0 h-screen w-screen md:pl-52 md:pt-16 pt-2 overflow-hidden">
      ...
      >
        <div className="h-full col-span-3 md:col-span-4 overflow-y-scroll no-scrollbar">
          <div
            className={`border-b relative bg-black ${
              showComments ? "" : "lg:h-10/12 md:flex md:justify-center "
            } `}
          >
            <div className="aspect-video min-h-full max-lg:min-w-full lg:max-h-[80%]n">
              <button
          ...
          <div className="w-full py-3 px-6 flex flex-col gap-8">
            <ChannelContainer
              streamData={streamData.streamSearch}
              streamId={streamId}
              following={streamData.following}
              liked={streamData.liked}
            />
            <div className="w-11/12 mx-auto">
