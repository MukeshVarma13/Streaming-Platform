...
public class User implements Serializable {
    ...
    private Community ownedCommunity;
    ...
    @JsonManagedReference(value = "community_members")
    @ToString.Exclude
    @Builder.Default
    private Set<Community> member = new HashSet<>();

    @OneToMany(mappedBy = "sender", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    @JsonManagedReference(value = "channel_messages")
    @ToString.Exclude
    @Builder.Default
